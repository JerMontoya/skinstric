...
export default function Header({ variant = "default", spanText, className = "", }: HeaderProps) {
  return (
    <header className={`w-full flex items-center justify-between py-5 px-8 ${className}`}>
      {/* Left side */}
